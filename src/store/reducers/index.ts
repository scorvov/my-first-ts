import {ISetFetchingToSuccess, SET_FETCHING_TO_SUCCESS} from "../actions";
...
type TProductAction = ISetFetchingToSuccess;

export const reducer = (state = initialProductState, action:TProductAction) => {
